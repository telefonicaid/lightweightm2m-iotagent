...
function readAttribute(ngsiDevice, lwm2mDevice, attribute, innerCallback) {
    function handleReadAttribute(err, value) {
        return innerCallback(null, value)
    }
    sendLwm2mOperation(lwm2mLib.read, ngsiDevice, lwm2mDevice, attribute, null, handleReadAttribute);
}
