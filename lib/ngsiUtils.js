...
function createClient(host, port, service, subservice) {
    return {
        query: queryEntity.bind(this, host, port, service, subservice),
        update: updateEntity.bind(this, host, port, service, subservice),
        discover: discoverContextAvailability.bind(this, host, port, service, subservice)
    };
}
