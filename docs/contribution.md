...
*   When reporting a vulnerability on the software, please, put in contact with IoT Agent Lightweightm2m repository maintainers in order to discuss it 
    in a private way.

## How to contribute

If you'd like to contribute, start by searching through the [issues](https://github.com/telefonicaid/lightweightm2m-iotagent/issues) and
[pull requests](https://github.com/telefonicaid/lightweightm2m-iotagent/pulls) to see whether someone else has raised a similar idea or
...
[Issues](https://github.com/telefonicaid/lightweightm2m-iotagent/issues) and [Pull Requests](https://github.com/telefonicaid/lightweightm2m-iotagent/pulls)
